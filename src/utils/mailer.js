        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;">
          ...
          <tr>
            <td style="padding:40px 40px 24px;">
              ...
              <!-- Attachment Included -->
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;border:1px solid #d1e7d8;border-radius:8px;overflow:hidden;background:#f0faf4;">
                <tr>
                  <td style="padding:16px 20px;border-bottom:1px solid #d1e7d8;">
                    <p style="margin:0;color:#22c55e;font-size:14px;font-weight:700;">📎 ATTACHMENT INCLUDED</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:20px;">
                    <p style="margin:0 0 12px;color:#333;font-size:13px;line-height:1.8;">
                      The generated UCT file containing all ${teamsGenerated} structured football virtual teams for this match has been attached to this email.
                    </p>
                    <div style="background:#ffffff;border:1px solid #d1e7d8;border-radius:6px;padding:12px;margin-top:12px;">
                      <p style="margin:0;color:#666;font-size:13px;font-weight:600;">📄 ${attachmentFileName}</p>
                    </div>
                  </td>
                </tr>
              </table>
