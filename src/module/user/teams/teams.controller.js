...
//       if (capValue !== null) lines.push(`Salary Cap    : ${capValue}`);
//       lines.push("");

//       if (captaincyMode !== "NONE") {
//         lines.push("********************");
...
//       lines.push("TEAM\tDT_NO\tCODE\tNAME\tROLE\tCAP\tSALARY\tSELECTED\tSIDE");
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        const [[matchInfo]] = await conn.query(
          `SELECT
                  m.matchdate,
                  m.start_time,
                  m.hometeamname,
